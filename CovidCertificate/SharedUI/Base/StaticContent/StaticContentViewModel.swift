...
struct StaticContentViewModel: Codable, Equatable {
    ...
    static let theApp = StaticContentViewModel(heading: UBLocalized.wallet_onboarding_app_header,
                                               ...
                                               alignment: "center",
                                               textGroups: [TextGroup(image: nil, imageColor: nil, imageAltText: nil, text: UBLocalized.wallet_onboarding_app_text, accessibilityIdentifier: "onboarding_text")])
    ...
    static let store = StaticContentViewModel(heading: UBLocalized.wallet_onboarding_store_header,
                                              ...
                                              textGroups: [TextGroup(image: "ic-privacy", imageColor: UIColor.cc_green_dark.ub_hexString, imageAltText: nil, text: UBLocalized.wallet_onboarding_store_text1, accessibilityIdentifier: nil) /* ,
    ...
    static let show = StaticContentViewModel(heading: UBLocalized.wallet_onboarding_show_header,
                                             ...
                                             textGroups: [TextGroup(image: "ic-qr-certificate", imageColor: UIColor.cc_green_dark.ub_hexString, imageAltText: nil, text: UBLocalized.wallet_onboarding_show_text1, accessibilityIdentifier: nil),
                                                          TextGroup(image: "ic-check-mark", imageColor: UIColor.cc_green_dark.ub_hexString, imageAltText: nil, text: UBLocalized.wallet_onboarding_show_text2, accessibilityIdentifier: nil)])
    ...
    static let howItWorks = StaticContentViewModel(foregroundImage: "illu-how-it-works",
                                                   ...
                                                   textGroups: [TextGroup(image: "ic-bund-small", imageColor: nil, imageAltText: nil, text: UBLocalized.wallet_scanner_howitworks_text1, accessibilityIdentifier: nil),
                                                                TextGroup(image: "ic-one", imageColor: UIColor.cc_green_dark.ub_hexString, imageAltText: nil, text: UBLocalized.wallet_scanner_howitworks_text2, accessibilityIdentifier: nil),

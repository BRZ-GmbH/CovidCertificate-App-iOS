...
struct StaticContentViewModel: Equatable {
    ...
    static let store = StaticContentViewModel(heading: UBLocalized.wallet_onboarding_store_header,
                                              ...
                                              textGroups: [(UIImage(named: "ic-privacy")?.ub_image(with: .cc_blue), UBLocalized.wallet_onboarding_store_text1) /* ,
    ...
    static let show = StaticContentViewModel(heading: UBLocalized.wallet_onboarding_show_header,
                                             ...
                                             textGroups: [(UIImage(named: "ic-qr-certificate")?.ub_image(with: .cc_blue), UBLocalized.wallet_onboarding_show_text1),
                                                          (UIImage(named: "ic-check-mark")?.ub_image(with: .cc_blue), UBLocalized.wallet_onboarding_show_text2)])
    ...
    static let privacy = StaticContentViewModel(heading: UBLocalized.wallet_onboarding_privacy_header,
                                                ...
                                                textGroups: [(UIImage(named: "ic-data-protection")?.ub_image(with: .cc_blue), UBLocalized.wallet_onboarding_privacy_text)])
    ...
    static let howItWorks = StaticContentViewModel(foregroundImage: UIImage(named: "illu-how-it-works"),
                                                   ...
                                                   textGroups: [(UIImage(named: "ic-bund-small"), UBLocalized.wallet_scanner_howitworks_text1),
                                                                (UIImage(named: "ic-one")?.ub_image(with: .cc_blue), UBLocalized.wallet_scanner_howitworks_text2),
                                                                (UIImage(named: "ic-two")?.ub_image(with: .cc_blue), UBLocalized.wallet_scanner_howitworks_text3),
                                                                (UIImage(named: "ic-three")?.ub_image(with: .cc_blue), UBLocalized.wallet_scanner_howitworks_text4)],
